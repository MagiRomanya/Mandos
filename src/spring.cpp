...
inline Vec3 get_particle_spring_energy_gradient(const SpringParameters& param, const Vec3& x1, const Vec3& x2, const Vec3& v1, const Vec3& v2, Scalar L) {
...
inline Mat3 get_particle_spring_energy_hessian(const SpringParameters& param, Scalar TimeStep, const Vec3& x1, const Vec3& x2, Scalar L) {
...
inline Scalar get_rigid_body_spring_energy(const SpringParameters& param,
                                           const Scalar L)
{
...
inline Vec6 get_rigid_body_spring_gradientA(const SpringParameters& param,
                                            const Vec3& u, const Vec3& posA, const Mat3& RA,
                                            const Scalar L)
{
    Vec6 grad;
...
inline Mat6 get_rigid_body_spring_hessAB(const SpringParameters& param,
                                         const Vec3& u,
                                         const Vec3& posA, const Mat3& RA,
                                         const Vec3& posB, const Mat3& RB,
                                         const Scalar L)
{
    Mat6 hess;
    const Mat3 uut = u * u.transpose();

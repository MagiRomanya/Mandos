...
void compute_energy_and_derivatives_finite(Scalar TimeStep,
                                    ...
                                    EnergyAndDerivatives& out)
{
    ...
    // Here the energies must place the energy, gradient and Hessians to the correct place in the global energy and
...
inline Vec compute_energy_gradient_finite(Scalar E0,
                                          Scalar dx,
                                          Scalar TimeStep,
                                          const Energies& energies,
                                          const PhysicsState& state,
...
inline Mat compute_energy_hessian_finite(Scalar E0,
                                         Scalar dx,
                                         Scalar TimeStep,
                                         const Energies& energies,
                                         const PhysicsState& state,

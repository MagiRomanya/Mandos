...
- Think this through. Right now is it possible to do a lot by having the internal structures accessible from the ~mandos.hpp~. However, it might be a confusing API for a new user to take advantage of.
...
CLOSED: [2024-06-11 Tue 17:25]
** DONE Test initial conditions
CLOSED: [2024-06-11 Tue 17:25]
** TODO Test material parameters
- Computing gradients with respect to the rest length of a rigid body spring does not compute correct gradients.
  - Why it does not work?
  - Test rest length of a single particle-spring.
